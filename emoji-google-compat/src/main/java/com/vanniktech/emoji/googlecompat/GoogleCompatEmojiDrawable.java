...
final class GoogleCompatEmojiDrawable extends Drawable {
  ...
  private ReplacementSpan emojiSpan; /* GoogleCompatEmojiDrawable shall not be used */
  ...
  private void process() {
    ...
    if (emojiCharSequence instanceof Spanned) {
      final Object[] spans = ((Spanned) emojiCharSequence).getSpans(0, emojiCharSequence.length(), ReplacementSpan.class);
      if (spans.length > 0) {
        emojiSpan = (ReplacementSpan) spans[0];
      }
    }
  }
