...
public class RecentEmojiManagerTest {
    private IRecentEmoji recentEmojiManager;
  ...
  @Test public void addEmoji() {
    ...
    assertThat(recentEmojiManager.getRecentEmojis()).hasSize(2).containsExactly(
  ...
  @Test public void addSkinTone() {
    ...
    assertThat(recentEmojiManager.getRecentEmojis()).hasSize(1);

    // the object equality to be reviewed.
